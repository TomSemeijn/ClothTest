...
// ctor
///////////////////////////////////////////////////////////////////////////////
SphereGenerator::SphereGenerator(float radius, int sectors, int stacks, bool smooth) : interleavedStride(32)
{
...
// setters
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::set(float radius, int sectors, int stacks, bool smooth)
{
    this->radius = radius;
...
void SphereGenerator::setRadius(float radius)
{
    if(radius != this->radius)
        set(radius, sectorCount, stackCount, smooth);
}

void SphereGenerator::setSectorCount(int sectors)
{
    if(sectors != this->sectorCount)
        set(radius, sectors, stackCount, smooth);
}

void SphereGenerator::setStackCount(int stacks)
{
    if(stacks != this->stackCount)
        set(radius, sectorCount, stacks, smooth);
}

void SphereGenerator::setSmooth(bool smooth)
{
...
// print itself
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::printSelf() const
{
    std::cout << "===== Sphere =====\n"
              << "        Radius: " << radius << "\n"
...
// dealloc vectors
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::clearArrays()
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::buildVerticesSmooth()
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::buildVerticesFlat()
{
    const float PI = acos(-1);
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::buildInterleavedVertices()
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::addVertex(float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::addNormal(float nx, float ny, float nz)
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::addTexCoord(float s, float t)
{
...
///////////////////////////////////////////////////////////////////////////////
void SphereGenerator::addIndices(unsigned int i1, unsigned int i2, unsigned int i3)
{
...
///////////////////////////////////////////////////////////////////////////////
std::vector<float> SphereGenerator::computeFaceNormal(float x1, float y1, float z1,  // v1
